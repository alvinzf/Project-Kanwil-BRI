...
require_once('./import-pairing-fo.php');
...
<body>
    ...
    <div class="container-fluid ms">
        ...
        <div class="container">
            ...
            <div class="form-group text-center border border-warning rounded p-4 mb-5 " style="margin-top:50px;">

                <div style="display: inline-flex;">
                    <!-- Import excel -->
                    <div>
                        <form action="" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                            <label>Pilih File Excel Pairing Fo</label>
